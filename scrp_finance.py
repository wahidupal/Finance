...
tech_list = ['AAPL', 'GOOG', 'MSFT', 'AMZN', 'TSLA', 'FB', 'NFLX', 'BABA', 'F', 'DB', 'INTC']
...
company_list = [AAPL, GOOG, MSFT, AMZN, TSLA, FB, NFLX, BABA, F, DB, INTC]
company_name = ["APPLE", "GOOGLE", "MICROSOFT", "AMAZON", "TESLA", "FACEBOOK", "NETFLIX", "ALIBABA", "FORD", "DEUTSCHE BANK", "INTEL" ]
